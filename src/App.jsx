    ...
    <div style={{ display:'flex', flexDirection:'column', height:'100vh', overflow:'hidden' }}>
      ...
      {alerta && (
        <div style={{ position:'fixed',inset:0,background:'rgba(0,0,0,.75)',zIndex:1000,display:'flex',alignItems:'center',justifyContent:'center',backdropFilter:'blur(3px)' }}
          ...
          <div style={{ background:'#111827',border:'1px solid #2a3a4a',borderTop:'3px solid #f39c12',borderRadius:10,minWidth:420,maxWidth:600,width:'90%',maxHeight:'80vh',display:'flex',flexDirection:'column',overflow:'hidden' }}>
            ...
            <div style={{ padding:16,overflowY:'auto',color:'#e2e8f0' }}>
                  ...
                  {alerta.tipo === 'alerta' && alerta.prox && (
                    <div style={{ background:'#1a1200',border:'1px solid #f59e0b',borderRadius:6,padding:12 }}>
                      ...
                      <div style={{ fontSize:12,color:'#8899aa',lineHeight:1.8 }}>
                        ...
                        <strong style={{color:'#e2e8f0'}}>Pavimentos:</strong> {alerta.prox.pavimentos}<br/>
                        <strong style={{color:'#e2e8f0'}}>Ciclos:</strong> {alerta.prox.ciclos?.join(', ')}
                      </div>
